    ...
    return ( 
        <>
                <div className="text-center mt-32 mb-10">
                     <h1 className="text-3xl md:text-4xl font-semibold text-blue-400">ALL COLLEGS</h1>
                </div>

           <div className="college-cards flex flex-row gap-7 lg:gap-5 flex-wrap justify-around mb-32">

              <Link to='/colleges/123'>
                <div className="card flex flex-col   rounded-xl shadow-sm shadow-slate-700 px-7 py-5 lg:p-2 items-center">
                   ...
                   <div className="college-info grow px-2 lg:py-5">
                      ...
                      <div className="header flex items-center justify-between border-b-[1px] border-white/10 pb-5">
                        ...
                        <div className="hidden  text-slate-400/50 text-xl cursor-pointer font-semibold p-2 rounded-full border-1 border-black hover:bg-slate-700 hover:text-white"><HiOutlineBookmark/></div>
                          ...
                          <div className="course-info flex flex-col mt-3 grow">
                             ...
                             <div className='flex list-none font-semibold gap-3 flex-col '>
                                ...
                                <div className="flex flex-col gap-2">
                                     <li>
                                        <h3 className='text-slate-600 text-sm leading-5 inline-block mx-3'>Course Offered</h3>
                                        <p className='text-lg text-blue-500 inline-block '>3 Courses</p>
                                    </li>
                                ...
                                <div className="flex flex-col gap-2">
                                    <li>
                                        <h3 className='text-slate-600 text-sm leading-5 inline-block mx-3 '>1st Year Tution Fee</h3>
                                        <p className='text-lg text-slate-400 inline-block '>21 Lakhs</p>
                                    </li>
                                ...
                                <div className="flex flex-col gap-2">
                                    <li>
                                        <h3 className='text-slate-600 text-sm leading-5 inline-block mx-3 '>Exam Accepted</h3>
                                        <p className='text-lg text-slate-400 inline-block '>TOEFL ,IELETS +1</p>
                                    </li>
