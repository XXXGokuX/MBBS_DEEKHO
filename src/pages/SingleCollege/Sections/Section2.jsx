...
import pimg from "../../../images/professor.jpg"
        ...
        <>
           <div className="collge-video-intro mt-20">
                ...
                <div className="college-video aspect-video relative">
                    <img src={pimg} alt='professor' className="object-cover w-full"/>
                ...
                <div className="youtube-video-player fixed top-0 left-0 z-20 w-screen h-screen bg-black/80 flex items-center">
                    ...
                    <div className="h-[80%] w-[95%]  md:w-[90%] mx-auto md:px-0">
                        ...
                        <iframe className="w-full h-[65%] md:h-full" src="https://www.youtube.com/embed/9IwNPwlOb_s" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
