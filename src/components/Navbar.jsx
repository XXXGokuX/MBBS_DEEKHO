...
const menu= [
    {value: 'Home', icon: <HiOutlineHome/>,url: '/'},
    {value: 'User', icon: <HiOutlineUser/>,url: '/login'},
    {value: 'Search', icon: <HiOutlineMagnifyingGlass/>,url: '/colleges'},
    {value: 'Contact', icon: <HiOutlinePhone/>,url: '/contact'}
]
